	...
	<div class="container h-100">
		...
		<c:if test="${not empty unmatched}">
			<div class="alert alert-danger alert-dismissible fade show">
				<strong>Đổi mật khẩu!</strong> Mật khẩu &amp; Xác nhận mật khẩu
				không giống.<br>Vui lòng thử lại.
				<button type="button" class="close" data-dismiss="alert">&times;</button>
			</div>
		</c:if>
		...
		<div class="d-flex justify-content-center h-100">
			<div class="row">
				<div class="col-md-12">
					<form
						action="${pageContext.request.contextPath}/customer/changeCustomerPassword"
						method="post">
						...
						<div class="form-group">
							<label class="col-form-label">Xác nhận mật khẩu</label> <input
								type="password" size="35" placeholder="Xác nhận mật khẩu"
