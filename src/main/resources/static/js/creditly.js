var Creditly = (function() {
  ...
  var createSelectorValidatorMap = function(expirationSelector, creditCardNumberSelector, cvvSelector, options) {
    ...
    optionValues["security_code_message"] = optionValues["security_code_message"] || "Mã bảo mật của bạn không hợp lệ";
    optionValues["number_message"] = optionValues["number_message"] || "Số thẻ tín dụng của bạn không hợp lệ";
    optionValues["expiration_message"] = optionValues["expiration_message"] || "Ngày hết hạn của thẻ không hợp lệ!";
