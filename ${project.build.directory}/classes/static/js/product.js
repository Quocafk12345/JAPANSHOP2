   $(document).ready(function() {
    ...
    $("#submit").on("click", function() {
        ...
        if (name === "" || file === "" || mrp_price ==="" || active === "" || price === "" || description === "") {
            ...
            $("#error_file").html("Vui lòng nhập đầy đủ thông tin.");
            $("#error_active").html("Vui lòng nhập đầy đủ thông tin.");
            $("#error_mrp_price").html("Vui lòng nhập đầy đủ thông tin.");
            $("#error_price").html("Vui lòng nhập đầy đủ thông tin.");
            $("#error_description").html("Vui lòng nhập đầy đủ thông tin.");
        } else {
