...
public class ProductAdmController {
	...
	@GetMapping("/add")
	public String addProduct(HttpSession session, RedirectAttributes redirectAttributes) {
		String aemail = (String) session.getAttribute("aemail");
		if(aemail == null) {
			 redirectAttributes.addFlashAttribute("errorMessage", "Vui lòng đăng nhập để sử dụng dịch vụ của admin");
	...
	public @ResponseBody ResponseEntity<?> createProduct(@RequestParam("name") String name,
		...
		try {
			...
			if (fileName == null || fileName.contains("..")) {
				model.addAttribute("Không hợp lệ", "Xin lỗi! Tên file có ký tự không hợp lệ \" + fileName");
				return new ResponseEntity<>("Xin lỗi! Tên file có ký tự không hợp lệ " + fileName,
	...
	public String deleteProduct(@PathVariable("id") Long pid, @PathVariable("fileName") String fileName,
		...
		try {
			...
			if (fileName == null || fileName.contains("..")) {
				rda.addFlashAttribute("Không hợp lệ", "Xin lỗi! Tên file có ký tự không hợp lệ \" + fileName");
	...
	public @ResponseBody ResponseEntity<?> updateProduct(@RequestParam("name") String name,
		...
		try {
			...
			log.info("Cập nhật sản phẩm với mã : "+code);
