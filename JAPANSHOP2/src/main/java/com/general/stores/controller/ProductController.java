...
public class ProductController {
	...
	@PostMapping("/search")
	String searchProducts(@RequestParam(value = "keyword", required = false) String keyword,
	...
	String searchProductByPriceRange(@RequestParam("fromPrice")Double formPrice,
									 @RequestParam("toPrice")Double toPrice, Model model) {
		try {
			List<Product> products = productService.searchProductsByPriceRange(formPrice, toPrice);
